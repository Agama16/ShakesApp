...
<nav class="navbar" id="navigation">
    <div class="navbar-container">
      ...
      <ul class="navbar-left" style="position: sticky;">
        ...
        <li>
          <a href="/giftCards/get">GIFT CARDS</a>
        </li>
      </ul>
      ...
      <ul class="navbar-right">
        ...
        <li> <button class="btn btn-outline-dark"><a href="/logIn/logIn">Sign in</a></button></li>
        <li> <button class="btn btn-dark"><a style="color:white;" href="./registerCustomer">Join now</a></button></li>
  ...
  <div class="smaller-menu hidden" id="menu">
    ...
    <div class="smaller-menu-bottom">
      <button class="btn btn-outline-dark"><a href= "/logIn/logIn"> Sign in</a></button>
      <button class="btn btn-dark"><a style="color:white;" href="./registerCustomer" > Join now</a></button>
