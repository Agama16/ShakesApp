...
//   res.render("foo", {id: req.session.id})
// }
...
async function registerCust(req, res) {
  ...
  //   await logInService.registerCust(firstName,sureName,adress,id, password, birthDay,gmail)    
  //   req.session.id = id
...
async function registerAdmin(req, res) {
  ...
  //     await logInService.registerAdmin(id, firstName,sureName,phone,salary,rank,branchId,password,joiningDate,birthDay)    
  //     req.session.id = id
